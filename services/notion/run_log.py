...
class RunLogNotionService:
    ...
    async def create_run_log_entry(
        self, event: str, status: str, details: str, document_id: str | None = None, event_type: str | None = None
    ) -> dict[str, Any]:
        ...
        if event_type:
            properties["Event Type"] = {"select": {"name": event_type}}
